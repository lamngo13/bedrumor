...
## ListImages
You can execute the `ListImages` Query using the following Query injector, which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts):

```javascript
injectListImages(options?: ListImagesOptions, injector?: Injector): CreateDataConnectQueryResult<ListImagesData, undefined>;
```

### Variables
The `ListImages` Query has no variables.
### Return Type
Recall that calling the `ListImages` Query injector returns a `CreateDataConnectQueryResult` object. This object holds the state of your Query, including whether the Query is loading, has completed, or has succeeded/failed, and any data returned by the Query, among other things.
...
To access the data returned by a Query, use the `CreateDataConnectQueryResult.data()` function. The data for the `ListImages` Query is of type `ListImagesData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `ListImages`'s Query injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectListImages, ListImagesOptions } from '@dataconnect/generated/angular'
...
export class MyComponent {
  ...
  query = injectListImages();

  // You can also pass in an options function (not object) of type `ListImagesOptions` to the Query injector function.
  options: ListImagesOptions = () => {
    return {
      staleTime: 5 * 1000
    };
  };
  query = injectListImages(this.options);
}
```
...
## CreateImage
You can execute the `CreateImage` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectCreateImage(options?: CreateImageOptions, injector?: Injector): CreateDataConnectMutationResult<CreateImageData, undefined, >;
```

### Variables
The `CreateImage` Mutation has no variables.
### Return Type
Recall that calling the `CreateImage` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.
...
To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `CreateImage` Mutation is of type `CreateImageData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `CreateImage`'s Mutation injector

```javascript
... // other imports
import { connectorConfig } from '@dataconnect/generated';
import { injectCreateImage, CreateImageOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  ...
  mutation = injectCreateImage();

  // You can also pass in a `CreateImageOptions` function (not object) to the Mutation injector function.
  options: CreateImageOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectCreateImage(this.options);
  ...
  executeMutation() {
    ...
    // You can also pass in a `CreateImageOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
...
## UpdateImage
You can execute the `UpdateImage` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectUpdateImage(options?: UpdateImageOptions, injector?: Injector): CreateDataConnectMutationResult<UpdateImageData, UpdateImageVariables, UpdateImageVariables>;
```
...
```
### Return Type
Recall that calling the `UpdateImage` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `CreateDataConnectMutationResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectMutationResult.isPending()`, `CreateDataConnectMutationResult.isSuccess()`, and `CreateDataConnectMutationResult.isError()` functions.

To execute the Mutation, call `CreateDataConnectMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation. 

To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `UpdateImage` Mutation is of type `UpdateImageData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `UpdateImage`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, UpdateImageVariables } from '@dataconnect/generated';
import { injectUpdateImage, UpdateImageOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Call the Mutation injector function to get a `CreateDataConnectMutationResult` object which holds the state of your Mutation.
  mutation = injectUpdateImage();

  // You can also pass in a `UpdateImageOptions` function (not object) to the Mutation injector function.
  options: UpdateImageOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectUpdateImage(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(updateImageVars);
    // Variables can be defined inline as well.
    this.mutation.mutate({ id: ..., name: ..., });

    // You can call `CreateDataConnectMutationResult.mutateAsync()` to execute the Mutation and return a promise with the data returned from the Mutation.
    this.mutation.mutateAsync(updateImageVars);

    // You can also pass in a `UpdateImageOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(updateImageVars, this.options());
  }
}
```

## DeleteImage
You can execute the `DeleteImage` Mutation using the `CreateDataConnectMutationResult` object returned by the following Mutation injector (which is defined in [dataconnect-generated/angular/index.d.ts](./index.d.ts)):
```javascript
injectDeleteImage(options?: DeleteImageOptions, injector?: Injector): CreateDataConnectMutationResult<DeleteImageData, DeleteImageVariables, DeleteImageVariables>;
```
...
```
### Return Type
Recall that calling the `DeleteImage` Mutation injector returns a `CreateDataConnectMutationResult` object. This object holds the state of your Mutation, including whether the Mutation is loading, has completed, or has succeeded/failed, among other things.

To check the status of a Mutation, use the `CreateDataConnectMutationResult.status()` function. You can also check for pending / success / error status using the `CreateDataConnectMutationResult.isPending()`, `CreateDataConnectMutationResult.isSuccess()`, and `CreateDataConnectMutationResult.isError()` functions.

To execute the Mutation, call `CreateDataConnectMutationResult.mutate()`. This function executes the Mutation, but does not return the data from the Mutation. 

To access the data returned by a Mutation, use the `CreateDataConnectMutationResult.data()` function. The data for the `DeleteImage` Mutation is of type `DeleteImageData`, which is defined in [dataconnect-generated/index.d.ts](../index.d.ts). It has the following fields:
```javascript
...
### Using `DeleteImage`'s Mutation injector

```javascript
... // other imports
import { connectorConfig, DeleteImageVariables } from '@dataconnect/generated';
import { injectDeleteImage, DeleteImageOptions } from '@dataconnect/generated/angular'
import { DataConnect } from '@angular/fire/data-connect';
import { initializeApp } from '@angular/fire/app';
...
export class MyComponent {
  // Call the Mutation injector function to get a `CreateDataConnectMutationResult` object which holds the state of your Mutation.
  mutation = injectDeleteImage();

  // You can also pass in a `DeleteImageOptions` function (not object) to the Mutation injector function.
  options: DeleteImageOptions = () => {
    return {
      onSuccess: () => { console.log('Mutation succeeded!'); }
    };
  };
  mutation = injectDeleteImage(this.options);
  ...
  executeMutation() {
    ...
    this.mutation.mutate(deleteImageVars);
    // Variables can be defined inline as well.
    this.mutation.mutate({ id: ..., });

    // You can call `CreateDataConnectMutationResult.mutateAsync()` to execute the Mutation and return a promise with the data returned from the Mutation.
    this.mutation.mutateAsync(deleteImageVars);

    // You can also pass in a `DeleteImageOptions` object (not function) to `CreateDataConnectMutationResult.mutate()`.
    this.mutation.mutate(deleteImageVars, this.options());
  }
}
```
